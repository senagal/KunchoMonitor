...
public class ContentService : IContentServices
{
    ...
    /// <returns>A task representing the asynchronous operation, with a list of <see cref="Content"/>.</returns>
    ...
    /// <returns>A task representing the asynchronous operation, with a <see cref="Content"/> as the result.</returns>
    ...
    /// <returns>A task representing the asynchronous operation, with the added <see cref="Content"/>.</returns>
